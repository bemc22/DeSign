...
parser.add_argument('--batch_center',    dest='batch_center', action='store_true')
parser.add_argument('--no-batch_center', dest='batch_center', action='store_false')

parser.add_argument('--batch_scale',    dest='batch_scale', action='store_true')
parser.add_argument('--no-batch_scale', dest='batch_scale', action='store_false')
